...
/**
  ...
  * @remark		
  */
size_t  MyQueue_GetCount(const MyQueue_Typedef *queue)
{
	if(queue==NULL)
		return 0;
...
/**
  ...
  * @remark		
  */
size_t MyQueue_GetLeftCount(const MyQueue_Typedef *queue)
{
	if(queue==NULL)
		return 0;
...
/**
  ...
  * @remark		
  */
size_t MyQueue_GetSize(const MyQueue_Typedef *queue)
{	
	if(queue==NULL)
		return 0;
...
/**
  ...
  * @remark		
  */
bool MyQueue_Peek(const MyQueue_Typedef *queue,void *buf,size_t num,size_t offset)
{
	size_t temprear;
	char *dst = (char *)buf;
	char *src;
	...
	if((offset+num) > (MyQueue_GetCount(queue)))
		return false;
